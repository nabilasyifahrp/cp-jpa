<style>
    ...
    <section id="about" class="position-relative text-white"
        style="background-color: #3461FF; padding-top: 4rem; padding-bottom: 8rem; overflow: hidden;">

        <div class="container position-relative px-3" style="z-index: 1;">
            <ul class="nav nav-tabs border-0 mb-4">
                <li class="nav-item"><button class="nav-link text-white active" data-tab="Who">Who</button></li>
                <li class="nav-item"><button class="nav-link text-white" data-tab="Vision & Mission">Vision & Mission</button></li>
                <li class="nav-item"><button class="nav-link text-white" data-tab="Values">Values</button></li>
                <li class="nav-item"><button class="nav-link text-white" data-tab="Brand">Brand</button></li>
                <li class="nav-item"><button class="nav-link text-white" data-tab="Application">Application</button>
                </li>
            </ul>
            ...
            <div class="row align-items-center flex-md-row flex-column-reverse">
                <div class="col-md-6 text-center text-md-start mb-4 mb-md-0">
                    <h3 id="tab-title" class="title" data-aos="fade-up" data-aos-duration="900">
                        <span style="color: white;">Who </span><span>We Are?</span>
                    </h3>
                ...
                <div class="col-md-6 d-flex justify-content-center justify-content-md-end" data-aos="fade-up" data-aos-duration="900">
                    <div class="about-image">
                        <img src="assets/images/about/about.png" alt="About Image" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </div>
